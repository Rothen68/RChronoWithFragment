 ...
 */
public class Frag_EditEx_BtnValider extends Fragment {
    public static final String FRAG_EDITEX_BTNVALIDER_CALLBACK = "FRAG_EDITEX_BTNVALIDER_CALLBACK";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.editionex_frag_valider, container, false);
        mBtnRetour = (Button) rootView.findViewById(R.id.editionex_frag_valider_btnValider);
