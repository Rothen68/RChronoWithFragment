 ...
 */
public class Frag_EditEx_BtnAjoutMorceau extends Fragment {
    public static final String FRAG_EDITEX_BTNAJOUTERMORCEAU_CALLBACK = "FRAG_EDITEX_BTNAJOUTERMORCEAU_CALLBACK";
    ...
    public Frag_EditEx_BtnAjoutMorceau() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.editionex_frag_ajoutmorceau, container, false);
        mBtnRetour = (Button) rootView.findViewById(R.id.editionex_frag_ajoutmorceau_btAjout);
