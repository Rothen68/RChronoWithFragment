...
public class ChronoModel {
     ...
     * @return
     *      état de la restoration : true si réussie
     * @see DAOBase
     */
     ...
     * @return
     *      état de la sauvegarde : true si réussie
     */
    public boolean save()
    {
        return true;
    ...
    public ArrayList<Sequence> getLibrairieSequences() {return m_libSequences;}
    public ArrayList<Exercice> getLibrairieExercices() {return m_libExercices;}
    public ArrayList<Sequence> getListeSequences() {return m_listeSequences;}
}
