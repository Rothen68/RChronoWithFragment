 ...
 */
public class ChronoCustomAdapter extends CustomAdapter {
    /**
     * Constructeur
     ...
     */
    public ChronoCustomAdapter(Context context) {
        super(context);
    }

    @Override
    public void setCallback(Frag_Liste_Callback callback) {
        mCallback = (Frag_Liste_Callback.Frag_Chrono_Liste_Callback) callback;
